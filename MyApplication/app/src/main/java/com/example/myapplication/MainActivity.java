...
//    public static boolean currentFragmentFlag = false;
...
//                    transaction.show(fragment);
    ...
    //获取当前fragment,作为fragmentFactory替代品
//    public Fragment getFragment(int position,int currentFragment){
...
//                return webViewFragment;
//            case 2:
//                webViewFragment.LoadURL("www.baidu.com");
//                return webViewFragment;
